...
function cubicBezierPoints(coords) {
  if (!Array.isArray(coords) || coords.length < 8) {
    return { curves: [], isClosed: false };
  }
  ...
  for (let i = 2; i + 5 < coords.length; i += 6) {
    ...
    // const curvePoints = [currentPoint, p1, p2, p3];
    const curvePoints = [currentPoint, p1, p2];
...
const start = [
  ...
  89.4523, 9.8831, 92.1165, 7.21905, 94.7807, 4.55501, 95.5208, 3.815, 96.7049,
  3.815, 97.445, 4.55501, 98.185, 5.29502, 98.185, 6.47904, 97.445, 7.21906,
  94.7808, 9.8831, 92.1166, 12.5471, 89.4523, 15.2112, 91.3025, 20.8353,
  89.3043, 36.5975, 71.3949, 54.5058, 66.1405, 59.7599, 59.776, 64.496, 53.2635,
  68.6401, 54.7436, 74.6341, 54.7436, 85.0683, 46.677, 92.3204, 37.5743,
  100.609, 28.9156, 95.7245, 30.7657, 93.9484, 32.2459, 92.3944, 41.3486,
  89.8784, 34.392, 78.9262, 30.6177, 80.7762, 28.3976, 80.6282, 27.2135,
  79.4442, 25.6593, 77.8902, 24.1052, 76.3362, 22.5511, 74.7821, 21.367,
  73.6721, 21.293, 71.3781, 23.0691, 67.678, 12.1163, 60.6479, 9.60009, 69.7501,
  8.11997, 71.3041, 6.26983, 73.0801, 1.38545, 64.422, 9.6741, 55.3198, 16.9267,
  47.2537, 27.3615, 47.2537, 33.356, 48.7337, 37.5003, 42.2216, 42.2366,
  35.8575, 47.4911, 30.6034,
];
